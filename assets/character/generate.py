...
def torso(px, oy):
    # plain white tee, short sleeves
    rect(px, 6, 12 + oy, 14, 20 + oy, TEE)
    rect(px, 9, 12 + oy, 11, 13 + oy, SKIN)            # collar opening
    rect(px, 6, 19 + oy, 14, 20 + oy, TEE_SH)          # hem shade
    rect(px, 12, 13 + oy, 14, 19 + oy, TEE_SH)         # body shade (right)
    # short sleeves + bare forearms
    rect(px, 4, 13 + oy, 6, 16 + oy, TEE); rect(px, 4, 16 + oy, 6, 20 + oy, SKIN)
    rect(px, 14, 13 + oy, 16, 16 + oy, TEE); rect(px, 14, 16 + oy, 16, 20 + oy, SKIN)
...
def draw_up(fi):
    ...
    rect(px, 6, 12 + oy, 14, 20 + oy, TEE)             # white tee back
    rect(px, 6, 19 + oy, 14, 20 + oy, TEE_SH)
    rect(px, 4, 13 + oy, 6, 16 + oy, TEE); rect(px, 4, 16 + oy, 6, 20 + oy, SKIN)
    rect(px, 14, 13 + oy, 16, 16 + oy, TEE); rect(px, 14, 16 + oy, 16, 20 + oy, SKIN)
...
def draw_side(fi):
    ...
    # body (white tee)
    rect(px, 7, 12 + oy, 13, 20 + oy, TEE)
    rect(px, 7, 19 + oy, 13, 20 + oy, TEE_SH)
    rect(px, 11, 13 + oy, 13, 19 + oy, TEE_SH)    # back shade
    # front arm swinging (sleeve + bare forearm)
    var_y = 18 if fi == 1 else (16 if fi == 2 else 17)
    rect(px, 6, 13 + oy, 8, 16 + oy, TEE)
    rect(px, 6, 16 + oy, 8, var_y + 2 + oy, SKIN)
    # head (profile, faces left): spiky hair, one eye, nose
